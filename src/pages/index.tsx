...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`TestReportsAnalysisDashboard`}</title>

        <meta
          name="description"
          content="Welcome to TestReportsAnalysisDashboard, your one-stop platform for maintaining and comparing test analysis reports across different builds."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1579154392128-bf8c7ebee541?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHx0ZXN0JTIwYW5hbHlzaXN8ZW58MHx8fHwxNjk1NTEyNjU3fDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            <Heading mb={{ base: '12px', lg: '20px' }} size="2xl">
              {`TestReportsAnalysisDashboard`}
            </Heading>
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to TestReportsAnalysisDashboard, your one-stop platform for maintaining and comparing test analysis reports across different builds.`}
            </Text>
            <Box
