...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'task.create.create': { roles: ['owner', 'team-member'], key: 'task', tenantPath: [], userPath: [] },
  'project.update.update': { roles: ['owner', 'team-member'], key: 'project', tenantPath: [], userPath: [] },
  'invoice.paid.update': { roles: ['owner'], key: 'invoice', tenantPath: [], userPath: [] },
};
